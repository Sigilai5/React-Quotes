...
class App extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            modal:false,
            events: [
                {id:1,time: "10:00", title: "Breakfast with Simon", location:"Nairobi",description:"Hello World"},
                {id:2,time: "11:00", title: "Lunch with James", description: "Hey There"},
                {id:3,time: "07:00", title: "Dinner with Bryant", location:"Mombasa",description: "Reaction to them"},
            ]
        };
    }
                ...
                <MDBContainer>
                    <MDBRow>
                        ...
                        <MDBCol  md="3" >
                            ...
                            <h6 className="my-3">
                                It's going to be a busy day.You have{" "}
